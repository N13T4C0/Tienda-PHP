    ...
    <table class="tabla">
        ...
        <tbody>
            <?php if (empty($usuarios)): ?>
                <tr>
                    <td colspan="7" class="txt-centro">No hay usuarios.</td>
                </tr>
            <?php endif; ?>
                ...
                <tr>
                    ...
                    <td class="txt-centro">
                        <a href="<?= URL_BASE ?>/admin/borrarUsuario/<?= $u->id ?>"
                            class="boton boton-borrar boton-pequeno"
    ...
    <p class="volver" style="margin-top:1rem;"><a href="<?= URL_BASE ?>/admin">&larr; Volver al panel</a></p>